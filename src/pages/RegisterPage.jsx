...
const RegisterPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // For UI demo purposes only - no actual registration
              ...
              <div>
                ...
                <div className="mt-2 space-y-2">
                  <div className="flex items-center">
                    ...
                    />
                    <label htmlFor="userType-user" className="ml-3 block text-sm text-gray-700">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300"
                    />
                    <label htmlFor="userType-lawyer" className="ml-3 block text-sm text-gray-700">
                ...
                <div>
                  ...
                  >
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                      <path
                        fillRule="evenodd"
                        d="M10 0C4.477 0 0 4.477 0 10c0 5.523 4.477 10 10 10 5.523 0 10-4.477 10-10 0-5.523-4.477-10-10-10zm-1.143 15.714h-.857v-5h.857v5zm1.143 0h.857v-7.143h-.857v7.143zm1.143 0h.857v-3.571h-.857v3.571z"
                        clipRule="evenodd"
                      />
                    </svg>
                  </button>
